            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h2><?php _e('You are looking for date:','eventoo');?></h2>
                        <h2><span class="search_keyword"><?php
                        $year     = get_query_var('year');
                        $monthnum = get_query_var('monthnum');

                        echo esc_html($GLOBALS['wp_locale']->get_month($monthnum) ." " . $year);
                        ?></span></h2>
                        </div>
                    </div>
                </div>
      ...
      <div class="row">
        <div class="col-lg-6 col-sm-6 t-c">
          ...
          <a href="<?php echo get_theme_mod('eventoo_topbar_right_icon_url_check','#')?>" class="bar">
             <i class="<?php echo get_theme_mod('eventoo_topbar_right_icon_check','fa fa-bars')?>" aria-hidden="true"></i>
          </a>
              <?php
                    endif;
              ?>
